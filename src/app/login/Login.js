...
export function LoginComponent() {
  ...
  async function handleSignIn() {
    setSpinner((
      <div role="status self-center ml-2">
        <svg aria-hidden="true" class="w-6 h-6 mr-2 text-gray-500 animate-spin dark:text-gray-400 fill-slate-200" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
